...
class ImgReply extends PureComponent {
    render() {
        const {
            params: {
                images: { dims = {}, backgroundColor } = {},
                docx: {
                    docxDims = {},
                    innerDiv = {},
                    footer = {},
                    backgroundColor: docxmainBg,
                    color,
                    fontSize,
                } = {},
                excel: {
                    ...
                    excelInnerDiv = {},
                    excelFooter = {},
                    backgroundColor: excelmainBg,
                    color: excelTextColor,
                    fontSize: excelTextSize,
                } = {},
                pdf: {
                    pdfDims = {},
                    pdfInnerDiv = {},
                    pdfFooter = {},
                    backgroundColor: pdfmainBg,
                    color: pdfTextColor,
                ...
                unknownExt: {
                    ...
                    unknownExtInnerDiv = {},
                    unknownExtFooter = {},
                    backgroundColor: unknownExtmainBg,
                    color: unknownExtTextColor,
                    fontSize: unknownExtTextSize,
                } = {},
            },
            downloadOptions,
            download,
        ...
        const { width: docxWidth } = docxDims;
        const {
            fontSize: docxinnerFS,
            color: docxinnerTC,
            backgroundColor: innerBg,
        } = innerDiv;
        const { fontSize: docxFooterFS, color: docxFooterFC } = footer;

        const { width: excelWidth } = excelDims;
        const {
            fontSize: excelinnerFS,
            color: excelinnerTC,
            backgroundColor: excelinnerBg,
        } = excelInnerDiv;
        const { fontSize: excelFooterFS, color: excelFooterFC } = excelFooter;

        const { width: pdfWidth } = pdfDims;
        const {
            fontSize: pdfinnerFS,
            color: pdfinnerTC,
            backgroundColor: pdfinnerBg,
        } = pdfInnerDiv;
        const { fontSize: pdfFooterFS, color: pdfFooterFC } = pdfFooter;

        const { width: unknownExtWidth } = unknownExtDims;
        const {
            fontSize: unknownExtinnerFS,
            color: unknownExtinnerTC,
            backgroundColor: unknownExtinnerBg,
        } = unknownExtInnerDiv;
        const {
            fontSize: unknownExtFooterFS,
            color: unknownExtFooterFC,
        } = unknownExtFooter;
        ...
        const customCss =
            this.props.message.get("customCss") &&
            this.props.message.get("customCss").toJS();
        ...
        const docExtension = image
            .split("/")
            [image.split("/").length - 1].split(".")[1];

        const youtubeExtension = image.split("/")[image.split("/").length - 2];
        ...
        return (
            <div
                ...
                <div className='rw-image-container'>
                    {docExtension !== undefined && docExtension === "docx" ? (
                        <div
                            ...
                            <p
                                className='rw-docx-heading'
                                style={{
                                    color: docxFooterFC,
                                    fontSize: docxFooterFS,
                                }}>
                                DOCX
                            </p>
                        </div>
                    ) : docExtension !== undefined && docExtension === "pdf" ? (
                        <div
                            className='rw-image-details'
                            style={{
                                width: pdfWidth,
                                ...
                                <span>
                                    <svg
                                        ...
                                        <linearGradient
                                            ...
                                            y1='1263.974'
                                            y2='956.949'
                                            gradientTransform='translate(1619.806 -922.943)'
                                            ...
                                            <stop
                                                offset='1'
                                                stopColor='#e1e1e1'></stop>
                                        </linearGradient>
                                        <path
                                            fill='url(#a)'
                                            d='M-46.192-137.833h278.339C293.931-93.941 364.489-28.38 412.777 43.095V471.29H-46.192v-609.123z'></path>
                                        <path
                                            fill='none'
                                            stroke='#c8c8c8'
                                            strokeWidth='0.5'
                                        ...
                                        <linearGradient
                                            ...
                                            y1='896.203'
                                            y2='872.127'
                                            gradientTransform='translate(1618.831 -924.375)'
                                            gradientUnits='userSpaceOnUse'>
                                            <stop
                                                offset='0'
                                                stopColor='#fff'></stop>
                                            <stop
                                                offset='1'
                                                stopColor='#c8c8c8'></stop>
                                        </linearGradient>
                                        <path
                                            fill='url(#b)'
                                            d='M232.147-137.833C299.36-88.92 363.359-28.669 412.777 43.095 380.77 9.85 336.879-7.895 284.796-5.617c6.153-61.643-17.619-101.453-52.649-132.216z'></path>
                                        <path
                                            fill='none'
                                            stroke='#c8c8c8'
                                            strokeWidth='0.5'
                                        ...
                                        <linearGradient
                                            ...
                                            y1='918.355'
                                            y2='1166.092'
                                            gradientTransform='matrix(1 0 0 -1 2229.395 1017.359)'
                                            gradientUnits='userSpaceOnUse'>
                                            <stop
                                                offset='0.127'
                                                stopColor='#8a0000'></stop>
                                            <stop
                                                offset='0.244'
                                                stopColor='#900000'
                                                stopOpacity='0.999'></stop>
                                            <stop
                                                offset='0.398'
                                                stopColor='#a00000'
                                                stopOpacity='0.999'></stop>
                                            <stop
                                                offset='0.573'
                                                stopColor='#bc0000'
                                                stopOpacity='0.998'></stop>
                                            <stop
                                                offset='0.761'
                                                stopColor='#e20000'
                                                stopOpacity='0.997'></stop>
                                            <stop
                                                offset='0.867'
                                                stopColor='#fa0000'
                                                stopOpacity='0.996'></stop>
                                        </linearGradient>
                                        <path
                                            fill='url(#c)'
                                            d='M-173.741-94.495h414.34V44.768h-414.34z'></path>
                                        <linearGradient
                                            id='d'
                                            x1='-2152.32'
                                            x2='-2239.196'
                      ...
                      docExtension === "xlsx" ? (
                        <div
                            ...
                            <p
                                ...
                                style={{
                                    color: excelFooterFC,
                                    fontSize: excelFooterFS,
                                }}>
                                XLSX
                            </p>
                        </div>
                    ) : docExtension !== undefined && docExtension === "mp4" ? (
                        <div
                        ...
                        <div
                          ...
                          docExtension === "png") ||
                      (docExtension !== undefined && docExtension === "jpg") ? (
                        <div
                            className='rw-image-details'
                            style={{ width, height, backgroundColor }}>
                    ...
                    {downloadOptions.show && (
                        <div
                            className='rw-download-image-container'
                            style={{
                                "background-color":
                            ...
                            {
                                // <img className="rw-download-image" src={DOWNLOAD} alt="Download" />
                            }
                            <Download fillColor={downloadOptions?.iconColor} />
                            {/* <a href={image} download={image.substring(image.lastIndexOf('/')+1)}>
                  <Download fillColor={downloadOptions?.iconColor} />
                </a> */}
                        </div>
                    )}
