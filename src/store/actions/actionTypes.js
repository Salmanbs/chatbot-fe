...
export const TOGGLE_ATTACH_DISABLED = 'TOGGLE_ATTACH_DISABLED';
export const TOGGLE_ATTACH_LOCATION_DISABLED = 'TOGGLE_ATTACH_LOCATION_DISABLED';
export const TOGGLE_INPUT_ENABLED = 'TOGGLE_INPUT_ENABLED';
export const TOGGLE_ATTACH_ENABLED = 'TOGGLE_ATTACH_ENABLED';
export const TOGGLE_ATTACH_LOCATION_ENABLED = 'TOGGLE_ATTACH_LOCATION_ENABLED';
...
export const ADD_NEW_USER_IMAGE_IMGREPLY = 'ADD_NEW_USER_IMAGE_IMGREPLY';
export const ADD_COMPONENT_MESSAGE = 'ADD_COMPONENT_MESSAGE';
export const ADD_QUICK_REPLY = 'ADD_QUICK_REPLY';
export const ADD_FAQ_REPLY = 'ADD_FAQ_REPLY';
export const ADD_CAROUSEL_TYPE1 = 'ADD_CAROUSEL_TYPE1';
export const ADD_CAROUSEL_TYPE2 = 'ADD_CAROUSEL_TYPE2';
export const ADD_COLLECTINFO_TYPE1 = 'ADD_COLLECTINFO_TYPE1';
export const ADD_CAPTURE_ATTYPE = 'ADD_CAPTURE_ATTYPE';
export const ADD_CAPTURE_LOCTYPE = 'ADD_CAPTURE_LOCTYPE';
export const SET_QUICK_REPLY = 'SET_QUICK_REPLY';
export const SET_FAQ_REPLY = 'SET_FAQ_REPLY';
export const SET_CAROUSEL_TYPE1 = 'SET_CAROUSEL_TYPE1';
export const SET_CAROUSEL_TYPE2 = 'SET_CAROUSEL_TYPE2';
export const SET_COLLECTINFO_TYPE1 = 'SET_COLLECTINFO_TYPE1';
export const SET_CAPTURE_ATTYPE = 'SET_CAPTURE_ATTYPE';
export const SET_CAPTURE_LOCTYPE = 'SET_CAPTURE_LOCTYPE';
